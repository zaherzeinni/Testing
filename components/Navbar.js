...
const Navbar = ({...rest}) => {
    return (
        <div {...rest}>
        <div className='flex flex-row justify-center   md:space-x-60 space-x-1 mt-3 '>
            {/* --------------LOGO----------- */}
            <div >
        ...
        <div className='md:space-x-8 mt-3 space-x-1 '>
           ...
           <div>
            <Button className='text-green-600 border border-solid border-green-600 p-2
             hover:bg-green-400 hover:text-white'>Sign in</Button>
           </div>
           <div>
