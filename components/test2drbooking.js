...
const Test2drbooking = () => {
    return (
   <div className='justify-center items-center flex flex-col w-[80%] sm:w-[100%]'>
   
    <div className='border-gray-200 sm:px-10 sm:py-4 border border-solid flex justify-center items-center shadow-sm '>
   ...
   <GoArrowRight className='ml-5  text-xl' />
        ...
        {/* -----------------time of day------------- */}
        <div className='flex justify-center p-4 py-8 border-gray-200 border-solid border shadow-sm   '>
        ...
        <div className='mt-3  lg:place-content-start lg:w-[70%] lg:flex lg:flex-row md:w-auto    '>
